...
<div class="card mb-2">
  <div class="flex-between mb-2">
    ...
    <a href="/generate_word/admin.php" class="btn btn-outline btn-sm">← Voltar</a>
  </div>
...
<div class="card mb-2">
  <form method="get" action="">
    ...
    <div class="flex gap-1 mt-1">
      ...
      <a href="/generate_word/admin.php" class="btn btn-outline btn-sm">Limpar</a>
    </div>
  </form>
</div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/generate_word/<?= htmlspecialchars($r['caminho_documento_gerado']) ?>" class="btn btn-outline btn-sm" download>
          ...
          <td class="text-right">
            <a href="/generate_word/#admin?ver=<?= $r['id_formulario_preenchido'] ?>" class="btn btn-outline btn-sm">Ver</a>
            <button class="btn btn-outline btn-sm btn-danger" onclick="excluir(<?= $r['id_formulario_preenchido'] ?>)">
...
window.excluir = function (id) {
  Swal.fire({
    title: 'Tem certeza?',
    text: "O arquivo gerado também será removido permanentemente!",
    icon: 'warning',
    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        const r = await fetch('actions/admin_action.php', { method: 'POST', body: fd });
        ...
        if (d.sucesso) {
          ...
          Swal.fire('Erro!', d.mensagem || 'Não foi possível excluir.', 'error');
        }
      } catch (e) {
