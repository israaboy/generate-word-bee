...
<div class="page-header-row">
  ...
  <div class="flex gap-1">
    <a href="/generate_word/#upload"     class="btn btn-outline btn-sm">+ Novo Template</a>
    <a href="/generate_word/#formulario" class="btn btn-primary btn-sm">+ Preencher</a>
  </div>
</div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right">
            <a href="#admin?ver=<?= $r['id_formulario_preenchido'] ?>" class="btn btn-outline btn-sm">Ver</a>
          </td>
        </tr>
